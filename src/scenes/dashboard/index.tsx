  ...
  return (
    <Box m="20px">
        ...
        <Box display="grid" gridTemplateColumns="repeat(12, 1fr)" gridAutoRows="140px" gap="20px">
            ...
            {/**Row 1 */}
            <Box backgroundColor={colors.primary[400]} gridColumn="span 3"  display="flex" alignItems="center" justifyContent="center">
             ...
             {/**Row 2 */}
            <Box backgroundColor={colors.primary[400]} gridColumn="span 3"  display="flex" alignItems="center" justifyContent="center">
              <StatBox title="431,361" subtitle="Sales Obtained " progress="0.50" increase="+21%" icon={<PointOfSaleIcon sx={{color: colors.greenAccent[600], fontSize: "26px"}} />} />
            ...
            <Box backgroundColor={colors.primary[400]} gridColumn="span 3"  display="flex" alignItems="center" justifyContent="center">
             ...
             {/**Row 1 */}
            <Box backgroundColor={colors.primary[400]} gridColumn="span 3" display="flex" alignItems="center" justifyContent="center">
              <StatBox title="1,235,361" subtitle="Traffic Received" progress="0.80" increase="+45%" icon={<TrafficIcon sx={{color: colors.greenAccent[600], fontSize: "26px"}} />} />
